...
@section('content')
    ...
    <section class="sm:flex sm:max-[1540px]:flex-wrap">
        <div
            class="sm:w-1/2 sm:max-[1540px]:w-full bg-taupe-200 py-10 drop-shadow-2xl justify-center items-center flex flex-col sm:flex-row gap-4 px-4">
            <h2 class="text-2xl sm:text-4xl font-light text-taupe-600 px-4 border-l-4 border-taupe-600">Gespecialiseerd In
            </h2>
