...
@section('content')
    ...
    <header class="bg-taupe-400 py-6 sm:py-8 md:py-10 drop-shadow-2xl justify-center items-center flex flex-col gap-4">
        <h1
            class="text-center p-3 sm:p-4 bg-taupe-600 border-x text-taupe-200 rounded-lg text-lg sm:text-2xl md:text-3xl text-shadow-lg border-none shadow-lg font-light">
            Mijn Projecten</h1>
    </header>

    <nav
        class="bg-taupe-200 py-4 flex flex-wrap gap-2 sm:gap-3 justify-center items-center border-b border-taupe-300 shadow-inner">
        <button data-filter="all"
            class="filter-btn px-4 py-1.5 sm:px-5 sm:py-2 rounded-lg bg-taupe-600 text-taupe-200 font-light text-sm sm:text-base transition-all duration-200 shadow-md">
            Alles
        </button>
        ...
        <button data-filter="python"
            class="filter-btn px-4 py-1.5 sm:px-5 sm:py-2 rounded-lg bg-taupe-600 text-taupe-200 font-light text-sm sm:text-base transition-all duration-200 shadow-md">
            Python
        </button>
        <button data-filter="unity"
            class="filter-btn px-4 py-1.5 sm:px-5 sm:py-2 rounded-lg bg-taupe-600 text-taupe-200 font-light text-sm sm:text-base transition-all duration-200 shadow-md">
            Unity
        </button>
    </nav>
    ...
    <section
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-stretch gap-3 sm:gap-4 md:gap-5 p-3 sm:p-4 md:p-6 bg-taupe-100">
        ...
        <article
            ...
            <h2
                class="bg-taupe-500 p-2 sm:p-3 md:p-4 rounded-lg text-2xl sm:text-3xl md:text-4xl font-light mb-3 sm:mb-4 text-taupe-300 text-center shadow-2xl">
                Takenbeheerder</h2>
            <div class="flex-1 flex items-center">
                <p
                    class="font-light bg-taupe-400 rounded-lg p-3 sm:p-4 text-sm sm:text-lg md:text-xl lg:text-2xl text-taupe-600 mb-3 sm:mb-4 text-center shadow-lg">
            ...
            <div class="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 mb-3 sm:mb-4 justify-center">
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">Python</span>
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">JSON</span>
            </div>
        ...
        <article
            ...
            <div class="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 mb-3 sm:mb-4 justify-center">
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">Laravel</span>
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">Tailwind
                    CSS</span>
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">PHP</span>
            </div>
        ...
        <article
            ...
            <div class="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 mb-3 sm:mb-4 justify-center">
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">Unity</span>
                <span
                    class="bg-taupe-600 text-taupe-300 px-2 sm:px-3 py-0.5 sm:py-1 rounded text-xs sm:text-sm md:text-xl">C#</span>
            </div>
