...
@section('content')
    ...
    <nav class="bg-taupe-200 py-4 flex flex-wrap gap-2 sm:gap-3 justify-center items-center border-b border-taupe-300 shadow-inner">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-stretch gap-3 sm:gap-4 md:gap-5 p-3 sm:p-4 md:p-6 bg-taupe-100">
